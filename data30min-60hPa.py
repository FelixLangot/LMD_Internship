...
print(0/13*100, '%')
data = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour59.nc')
data2 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour60.nc')
data3 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour61.nc')
data4 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour62.nc')
data5 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour63.nc')
data6 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour64.nc')
data7 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour65.nc')
data8 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour66.nc')
data9 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour67.nc')
data10 = Dataset(
    'NetCDF/rceiso_m60hPad_moovie_rceiso01_3D_dt30min_jour68.nc')
